...
export class ToolsPage extends BasePage {
    ...
    static get textSelector() {
        ...
        return {
            ...
            autoScaling: CommonPage.getHeaderTwoContainingText(
                ToolsPageConstants.earlyAccessList.autoScaling)
        };
    }
    ...
    static get anchorLinkSelectors() {
        return {
            homePageLink: CommonPage.getAnchorContainsClass(ToolsPageConstants.accessFeatureSelector.homePageClass),
        };
    }
}
